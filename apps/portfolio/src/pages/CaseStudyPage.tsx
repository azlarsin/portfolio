...
export function CaseStudyPage({
  ...
  const htmlVisuals =
    project.visuals?.filter((visual) => visual.kind === 'html-frame') || []
  const demoLivesInChapter = project.chapters.some(
    (chapter) => chapter.id === 'demo',
  )
      ...
      <div className="case-body-layout">
        <article className="case-content">
          ...
          <section
            ...
            aria-label={copy.caseStudy.visualLabel}
          >
          ...
          {project.links?.length ? (
            <nav
              ...
              aria-label={copy.caseStudy.externalLinks}
            >
