  ...
  'turntable-motion-lab': {
    ...
    guide: {
      zh: {
        ...
        steps: ['改变数据组合观察扇区重排。', '使用均分或随机占满，让当前全部扇区重新分配 100% 空间。', '悬停扇区查看聚焦状态，或按住 S 慢速检查连续运动。'],
      },
      en: {
        duration: 2,
        ...
        steps: ['Change the data composition to reorder sectors.', 'Use equal or random full-space allocation to redistribute 100% across the current slices.', 'Hover a slice to inspect focus, or hold S to study the motion in slow motion.'],
      },
    },
  },
